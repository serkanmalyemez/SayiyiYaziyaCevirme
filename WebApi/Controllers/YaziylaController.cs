...
{
    public class YaziylaController : ApiController
    {
        private string[] sehirler = new string[] { "Antalya", "Eskişehir", "İstanbul" };
        public string[] Get()
        {

            return new string[] { "Antalya", "Eskişehir", "İstanbul" };
        }
        ...
        public string Get(int id)
        {
            ...
            {
                donenSayi = "Sadece tam sayı girebilirsiniz.";
            }
